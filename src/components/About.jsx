...
import anil from "../assets/anil2.jpeg";

import resume from "../assets/files/AnilResume.pdf"
      ...
      >
        ...
        <div className="w-full h-[400px] md:h-auto flex flex-col items-center justify-center">
          <p className="text-lg text-slate-500 text-center">
            Hi, I'm Anil Kumar, and I'm graduating in Rajiv Gandhi University of
            Knoweldge and Technologies with a degree in Computer Science
            Engineering. My interests are in Full stack development with React as frontEnd,
