      ...
      <nav className="w-full px-6 z-50 fixed insert-x-0 top-2 flex justify-center items-center">
        <div className="w-full md:w-[800px] bg-neutral-800 p-4 rounded-2xl flex items-center">
          ...
          <div className="hidden md:flex items-center gap-6 ml-6 flex-1">
            ...
            <a href="#" className='ml-auto text-base text-slate-500 font-medium hover:text-slate-100 cursor-pointer border-slate-500 px-2 py-1 rounded-xl hover:border-gray-100 duration-100 ease-in-out'>Download</a>
