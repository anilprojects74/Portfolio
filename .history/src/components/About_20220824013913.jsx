...
export default function About() {
  return (
    <main className="w-[80%] mt-4">
      <div className="flex justify-center h-[100px] items-center text-slate-200 text-3xl">
        About Me
      </div>
      <section
      ...
      <div className="text-2xl text-slate-100 flex text-center h-[100px] items-center px-6 md:px-[120px]">
        Education
      </div>
