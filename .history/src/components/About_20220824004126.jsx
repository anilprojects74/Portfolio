    ...
    <main className="w-[80%] mt-4">
      ...
      >
        ...
        <div className="w-full h-[700px] md:h-auto flex flex-col items-center justify-center">
          ...
          Hi, I'm Sahith, and I'm graduating in Rajiv Gandhi
          University of Knoweldge and Technologies with a degree in 
          Computer Science Engineering. My interests are in Front End Web Development, 
          and I love to create beautiful and performant products with 
          delightful user experiences.
          </p>
          <p className="text-center text-slate-200">You can find my resume by clicking down below.</p>
